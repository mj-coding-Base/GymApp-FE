#!/bin/bash
# Quick workaround: Change port to 3002 to avoid conflict
# Run this on your VPS: ./CHANGE_PORT_QUICK.sh

set -e

echo "🔄 Changing port from 3002 to 3002..."
...
if [ -f "ecosystem.config.cjs" ]; then
    ...
    echo "✅ Updated ecosystem.config.cjs: PORT=3002"
fi

# Start with new port
echo ""
echo "🚀 Starting with port 3002..."
...
echo "   Update your reverse proxy/nginx to point to port 3002"
