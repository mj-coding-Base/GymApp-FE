...
# Step 3: Update port to 3001
echo "3️⃣  CHANGING PORT TO 3001..."
git pull 2>/dev/null || true

# Update ecosystem.config.cjs
sed -i 's/PORT: 3002/PORT: 3001/g' ecosystem.config.cjs
sed -i 's/PORT: 3001/PORT: 3001/g' ecosystem.config.cjs  # Ensure it's 3001
...
# Step 4: Verify port 3001 is free
echo "4️⃣  VERIFYING PORT 3001..."
if command -v lsof &> /dev/null; then
...
echo "6️⃣  STARTING APP ON PORT 3001..."
...
echo ""
echo "🌐 App is now on: http://localhost:3001"
echo ""
...
echo "   To:     proxy_pass http://localhost:3001;"
